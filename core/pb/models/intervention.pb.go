...
func file_proto_models_intervention_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_models_intervention_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_proto_models_intervention_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Habit); i {
			case 0:
				return &v.state
			case 1:
